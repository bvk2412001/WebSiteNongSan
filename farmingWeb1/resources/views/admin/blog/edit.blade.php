    ...
    <div class="row">
        <div class="col-md-9">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value = "{{$blog->name}}" name="name" placeholder="input name" disabled>
                @error('name')
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control"  placeholder="input description"> {{$blog->description}}</textarea>
                @error('description')
                <small class="help-block">{{$message}}</small>
                @enderror
            </div>
